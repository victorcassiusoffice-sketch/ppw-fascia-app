  ...
  return (
    <main className="px-5 py-8 max-w-3xl mx-auto pb-16">
      ...
      <Section title="Licence">
        <div className="card p-5">
          <div className="font-display">Licensed organizations only</div>
          <div className="text-muted text-xs mt-2 leading-relaxed">
            Peak Performance Wellness licenses this app per company, for that company’s staff.
            There is no public checkout. To arrange access, email victor@ppwellness.co.
          </div>
        </div>
      </Section>
